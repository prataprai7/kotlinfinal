...
fun DashboardScreen(navController: NavController, medexViewModel: MedexViewModel = viewModel()) {
    Scaffold(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.suppli),
            ...
            Row(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Icon(Icons.Filled.LocalPharmacy, contentDescription = "Supplements", tint = MaterialTheme.colorScheme.primary, modifier = Modifier.height(40.dp))
                        Spacer(modifier = Modifier.height(8.dp))
                        Text("Manage Supplements", style = MaterialTheme.typography.titleMedium)
                    }
                }
                Card(
                    modifier = Modifier
