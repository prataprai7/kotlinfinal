...
fun CheckoutScreen(navController: NavController, medexViewModel: MedexViewModel) {
    ...
    Column(
        ...
        if (showSuccessDialog) {
            AlertDialog(
                onDismissRequest = { showSuccessDialog = false; navController.popBackStack(com.example.proteinhub.presentation.Routes.USER_DASHBOARD, false) },
                title = { Text("Order Confirmed!") },
                text = { Text("Your order has been placed successfully.") },
                confirmButton = {
                    Button(onClick = { showSuccessDialog = false; navController.popBackStack(com.example.proteinhub.presentation.Routes.USER_DASHBOARD, false) }) {
                        Text("OK")
                    }
                }
            )
