...
fun LoginScreen(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = com.example.proteinhub.R.drawable.suppli),
        ...
        Button(
            onClick = {
                loginError = false
                medexViewModel.login(username, password) { success, userRole ->
                    println("DEBUG: Login callback - success: $success, userRole: $userRole")
                    if (success) {
                        if (userRole == "admin") {
                            ...
                            println("DEBUG: Navigating to user dashboard")
